...
namespace Z.PagedList.Web.Common
{
	public sealed class PagedListRenderOptions
	{
		...
		public PagedListRenderOptions()
		{
			...
			this.MaximumPageNumbersToDisplay = 10;
			...
			this.PageClasses = Enumerable.Empty<string>();
			this.UlElementattributes = null;
			this.ActiveLiElementClass = "active";
			this.EllipsesElementClass = "PagedList-ellipses";
			this.PreviousElementClass = "PagedList-skipToPrevious";
			this.NextElementClass = "PagedList-skipToNext";
		}
